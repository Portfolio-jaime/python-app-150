...
```sh
helm install python-app-150 ./charts/python-app-150 \
  --set image.repository=jaimehenao8126/python-app-150 \
  --set image.tag=<tag>
```

- Ingress por defecto: `python-app-150.test.com`
...
- [charts/python-app-1/](./charts/python-app-150/): Helm chart y valores
